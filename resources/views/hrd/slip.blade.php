...
@section('content')
    <div class="bg-white p-6 rounded-lg shadow">
        {{-- Header: alamat (kiri), logo+title (tengah), info pegawai (kanan) --}}
        @php
        ...
        <div class="text-center mb-8 relative">
            <img src="{{ $logo }}" alt="Logo" class="block mx-auto h-20 w-auto object-contain mb-6" onerror="this.onerror=null;this.src='https://placehold.co/180x60/003366/FFFFFF?text=LOGO'">
            <h1 class="text-3xl font-bold">Slip Gaji</h1>
        </div>

        <div class="flex justify-between items-start text-sm text-slate-600 mb-6">
            <div class="text-left">
                <div class="font-semibold">PT. Indosmart Komunikasi Global</div>
            ...
            <div class="text-right">
                ...
                <div class="mt-1">Periode Gaji: {{ $period }}</div>
            </div>
        </div>
