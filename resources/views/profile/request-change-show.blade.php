        ...
        <div class="p-6 border-b border-slate-200">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-slate-500">Diajukan pada: {{ $change->created_at->format('d M Y, H:i') }}</p>
                </div>
                <div>
                    @php
                        $statusClass = '';
                        if ($change->status == 'approved') $statusClass = 'bg-green-100 text-green-800';
                        elseif ($change->status == 'rejected') $statusClass = 'bg-red-100 text-red-800';
